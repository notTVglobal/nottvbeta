...
class ExternalSourcePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\ChannelExternalSource  $channelExternalSource
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, ChannelExternalSource $channelExternalSource)
    {
      $isAdmin = $user->isAdmin;
      // If the user is an admin, allow viewing
      if ($isAdmin) {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, ChannelExternalSource $channelExternalSource)
    {
      $isAdmin = $user->isAdmin;
      // If the user is an admin, allow viewing
      if ($isAdmin) {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, ChannelExternalSource $channelExternalSource)
    {
      $isAdmin = $user->isAdmin;
      // If the user is an admin, allow viewing
      if ($isAdmin) {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, ChannelExternalSource $channelExternalSource)
    {
      $isAdmin = $user->isAdmin;
      // If the user is an admin, allow viewing
      if ($isAdmin) {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, ChannelExternalSource $channelExternalSource)
    {
      $isAdmin = $user->isAdmin;
      // If the user is an admin, allow viewing
      if ($isAdmin) {
