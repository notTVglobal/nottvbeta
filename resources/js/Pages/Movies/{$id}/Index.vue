            ...
            <div class="container mx-auto px-4">
                <div class="movie-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
                    ...
                    <div class="lg:ml-12 lg:mr-0">
                        ...
                        <p v-if="video.upload_status !== 'processing' && !video.file_name && movie.file-url" class="mt-12 px-3 py-3 text-gray-50 mr-1 lg:mr-36 bg-black w-full text-center lg:text-left">
