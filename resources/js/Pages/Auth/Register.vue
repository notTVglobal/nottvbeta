          ...
          <div
            ...
            <form @submit.prevent="submit" class="pb-10">
              ...
              <div>
                ...
                <label for="name" class="input input-bordered input-primary flex items-center gap-2 text-black bg-white dark:bg-gray-800 dark:text-white">
                  ...
                  <input id="name"
                         v-model="form.name" type="text" class="grow border-0 text-black bg-white dark:bg-gray-800 dark:text-white" placeholder="Name" autocomplete="name"
                         required/>
                </label>
              </div>
              ...
              <div class="mt-4">
                <label for="email" value="Email" class="input input-bordered input-primary flex items-center gap-2 text-black bg-white dark:bg-gray-800 dark:text-white">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                       class="w-4 h-4 opacity-70">
                    <path
              ...
              <div class="mt-4">
                ...
                <label for="password_confirmation" class="input input-bordered input-primary flex items-center gap-2 text-black bg-white dark:bg-gray-800 dark:text-white">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                       class="w-4 h-4 opacity-70">
                    <path fill-rule="evenodd"
                          d="M14 6a4 4 0 0 1-4.899 3.899l-1.955 1.955a.5.5 0 0 1-.353.146H5v1.5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-2.293a.5.5 0 0 1 .146-.353l3.955-3.955A4 4 0 1 1 14 6Zm-4-2a.75.75 0 0 0 0 1.5.5.5 0 0 1 .5.5.75.75 0 0 0 1.5 0 2 2 0 0 0-2-2Z"
                  ...
                  <input id="password_confirmation"
                         v-model="form.password_confirmation" type="password" class="grow border-none text-black bg-white dark:bg-gray-800 dark:text-white" value=""
                         required/>
                </label>
              </div>
              ...
              <div class="mt-4">
                ...
                <JetInput
                    ...
                    type="text"
                    class="mt-1 block w-full input input-bordered input-accent text-black bg-white dark:bg-gray-800 dark:text-white"
                    required
                />
              </div>
