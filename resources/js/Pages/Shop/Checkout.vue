  ...
  <div class="place-self-center flex flex-col gap-y-3">
    <div id="topDiv" class="bg-white text-black dark:bg-gray-800 dark:text-gray-50 p-5 mb-10">
      ...
      <header class="flex justify-between mb-3">
        <div id="topDiv">
          <h1 class="text-3xl font-semibold pb-3">Checkout <span class="inline-block ml-1"
                                                                 v-text="'(' + shopStore.cart.length + ' items)'"></span>
          </h1>
        </div>
      </header>
        ...
        <div class="lg:w-2/3 w-full mx-auto mt-8">
          ...
          <div class="flex flex-wrap -ms-2 mt-4">
            <div class="p-2 w-full">
              <div class="relative">
                <label for="card_element" class="leading-7 text-sm text-black dark:text-gray-200">Credit Card
                  Information</label>
