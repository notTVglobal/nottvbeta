<template>
  ...
  <div class="place-self-center flex flex-col w-full overflow-x-hidden">
      ...
      <div class="bg-gray-900 text-white px-5">
          ...
          <div class="container mx-auto flex flex-col xl:flex-row items-center justify-between px-4 pb-4 md:py-6">
            ...
            <div class="hidden md:block flex flex-col xl:flex-row items-center">
              ...
              <ul class="flex md:pt-6 ml-0 xl:ml-16 mt-6 xl:mt-0 space-x-8">
                ...
                <li>
                  <button :href="``" @click.prevent="scrollToComingSoon" class="hover:text-blue-800">Coming Soon
                  </button>
                </li>
              </ul>
            </div>
        ...
        <main class="pb-8">
          ...
          <div class="container mx-auto px-6 border-b border-gray-800 pb-16 max-w-calc[100%-96rem]">
            ...
            <div
                class="popular-shows text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-12 justify-items-center">
                  ...
                  <div class="flex flex-col p-4">
                    ...
                    <div class="uppercase tracking-wider text-yellow-700 text-lg flex items-center gap-1">
                      ...
                      <div class="text-gray-600 text-lg">
                        ...
                        <span v-if="show.first_release_year > 0 && !show.last_release_year">({{
                            show.first_release_year
                          }})</span>
                        <span v-if="!show.last_release_year && !show.first_release_year">({{
                            show.copyrightYear
                          }})</span>
                      </div>
                    </div>
          ...
          <div class="w-full flex flex-col xl:flex-row my-10 px-6">
                    ...
                    <div class="flex flex-row bg-gray-800 rounded-lg shadow-md px-6 py-6">
                      ...
                      <div class="relative w-48 min-w-[12rem]">
                        ...
                        <div class="flex flex-col mt-4 w-full">
                          <div class="uppercase tracking-wider text-yellow-700 font-semibold">{{
                              episode.category.name
                            }}
                          </div>
                          <div v-if="episode.subCategory.name" class="text-yellow-500 font-thin">
                            {{ episode.subCategory.name }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="ml-3 block">
                        ...
                        <div class="flex flex-row w-full text-gray-200 font-light text-sm">
                          ...
                          &nbsp;<ConvertDateTimeToTimeAgo :dateTime="episode.releaseDateTime"
            ...
            <div class="xl:w-1/4 mt-12 xl:mt-0 xl:ml-4 mr-8">
              <h2 id="coming-soon"
                  class="tracking-wider text-yellow-500 uppercase font-semibold mt-10 xl:mt-0 text-2xl">
                Coming Soon</h2>
              <div class="space-y-10 mt-8">
                ...
                <div v-for="show in comingSoon"
                  ...
                  <button @click="appSettingStore.btnRedirect(`/shows/${show.slug}`)" class="flex flex-row text-left">
                    ...
                    <div class="ml-4">
                      <Link :href="`/shows/${show.slug}`" class="tracking-wide hover:text-gray-300">{{
                          show.name
                        }}
                      </Link>
                      <div class="uppercase tracking-wider text-yellow-700 text-sm mt-1">{{
                          show?.category?.name
                        }}
                      </div>
                      <div class="tracking-wide text-yellow-500 text-sm font-thin mt-1">{{
