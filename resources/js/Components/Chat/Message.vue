<template>
    <div :id="message.id" class="flex space-x-2 mb-2 pr-5 w-fit align-self-center">
       <div class="min-w-[2rem]">
        ...
        <div class="flex flex-col bg-gray-600 rounded-l-xl rounded-r-xl px-2 bg-opacity-50 break-words">
