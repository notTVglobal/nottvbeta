<template>
    <button @click.prevent="editor.chain().focus().toggleBold().run()" class="py-1 px-2 mb-2 bg-gray-200 hover:bg-gray-400 rounded-lg font-bold">
        B
    </button>
    <button @click.prevent="editor.chain().focus().toggleItalic().run()" class="py-1 px-3 ml-2 mb-2 bg-gray-200 hover:bg-gray-400 rounded-lg font-italic">
        i
    </button>
<!--    <button-->
