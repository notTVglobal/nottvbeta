<template>
    <div>
        ...
        <div class="absolute">
            <div class="relative h-[calc(h-100%-16rem)] pb-8 top-0">
                <chat-messages />
            </div>
            <div class="relative h-16">
                <input-message :user="props.user" class="fixed bottom-32"/>
            </div>
        </div>
    </div>
</template>
...
<script setup>
import InputMessage from "@/Components/VideoPlayer/Chat/FullPageChatInput"
