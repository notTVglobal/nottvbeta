<template>
    <div>
        ...
        <form @submit.prevent="">
            ...
            <input
                class="fixed bottom-0 right-10 p-2 m-2 mb-2 w-fit text-black form-control border-2 border-gray-800 hover:border-blue-800 focus:outline-none"
                type="text"
            ...
            />
            <span>
                <div @click="sendMessage" class="fixed bottom-0 right-0 p-2 m-2 mb-2 w-fit text-white form-control cursor-pointer">
