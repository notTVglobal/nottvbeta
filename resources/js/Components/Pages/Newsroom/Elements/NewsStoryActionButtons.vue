<template>
  <div class="flex flex-col justify-left w-fit space-y-1 space-x-1">
    ...
    <div v-if="!props.can.publishNewsStory && !newsStory.published_at && newsStory.status.id === 3"
         class="mr-6 text-gray-500 italic">
      <span>not yet published</span>
    </div>
    <div v-if="newsStory.published_at">
      <div class="mr-6 text-gray-800 dark:text-white font-semibold">
