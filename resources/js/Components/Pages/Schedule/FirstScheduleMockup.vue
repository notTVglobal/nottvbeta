  ...
  <div class="place-self-center flex flex-col gap-y-3 w-full overscroll-x-none pb-8">
    ...
    <table class="table-fixed mx-5">
      ...
      <tr class="border-b border-0.5 border-white">
        ...
        <td colspan="2"
            class="p-2 hidden lg:table-cell bg-yellow-800 text-sm 2xl:text-md border border-0.5 border-green-300 hover:bg-yellow-600 hover:border-blue-500 cursor-pointer">
          <div class="flex flex-col">
