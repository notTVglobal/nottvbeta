  ...
  <Teleport to="body">
    <Modal :show="teamStore.confirmManagerDialog" @close="teamStore.confirmManagerDialog = false">
      ...
      <template #footer>
        ...
        <button v-if="teamStore.addManager" @click.prevent="managerAddConfirmed"
                class="bg-blue-500 hover:bg-blue-600 py-2 px-4 text-white rounded-lg">Confirm Add
        </button>
        <button v-if="!teamStore.addManager" @click.prevent="managerRemoveConfirmed"
                class="bg-blue-500 hover:bg-blue-600 py-2 px-4 text-white rounded-lg">Confirm Remove
        </button>
