...
export const useUserStore = defineStore('userStore', {
    ...
    actions: {
        ...
        formatDateTimeWithYearFromUtcToUserTimezone(dateTime, formatString = 'ddd DD MMM, YYYY [at] h:mm a') {
            if (!this.timezone) {
                console.error('Timezone is not set.')
                return dateTime // Or handle this case as appropriate for your app
            }
        ...
        formatDateTimeFullWithYearFromUtcToUserTimezone(dateTime, formatString = 'dddd MMMM DD, YYYY [at] h:mm a') {
            if (!this.timezone) {
                console.error('Timezone is not set.')
                return dateTime // Or handle this case as appropriate for your app
            }
        ...
        formatDateTimeSimpleInUserTimezone(dateTime, formatString = 'ddd DD MMM  h:mm a') {
            if (!this.timezone) {
                console.error('Timezone is not set.')
                return dateTime // Or handle this case as appropriate for your app
            }
