...
@section('message')
    ...
    @endif
    <p>Oops! Looks like the content you were searching for is playing hide-and-seek. It might have moved or doesn't
        exist anymore. But don't worry, we've got plenty of other exciting channels to explore!</p>
